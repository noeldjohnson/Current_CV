...
\begin{minipage}{0.50\linewidth}
  \begin{tabular}{ll}
    ...
    Homepage: & \href{http://www.http://noeldjohnson.net/noeldjohnson.net/Home.html}{www.noeldjohnson.net} \\
  \end{tabular}
\end{minipage}
...
\begin{tabular}{ll}
	NYU, Abu Dhabi, Spring 2019 (Invitation Accepted) \\
...
\begin{tabular}{ll}
	Organizer of Washington Area Development and Economic History Workshop, 2010-Present \\
